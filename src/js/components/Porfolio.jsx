...
import Quote1 from '../../images/quotes_images/image1.png';
import Quote2 from '../../images/quotes_images/image2.png';
import Quote3 from '../../images/quotes_images/image3.png';
import Quote4 from '../../images/quotes_images/image4.png';
import Quote5 from '../../images/quotes_images/image5.png';

import Weather1 from '../../images/weather_images/image1.png';
        ...
        <section className="portfolio" id="portfolio" ref={newRef}>
            ...
            <div className="portfolio-desktop__body">
                <div className="portfolio-body">
                    ...
                    <div className={`portfolio-content${firstIn ? ' show-content' : ''}`}>
                        <img src={Quote1} alt="project" />
                        <div className="portfolio-content__show center-content">
                            <div className="title">
                            <h5>QUOTE GENERATOR MACHINE</h5>
                                <p>HTML / CSS / Javascript</p>
                            </div>
                            <div className="button">
                                <button onClick={() => setVisibleSeven(true)}>LEARN MORE</button>
                            </div>
                        </div>
                    </div><br />
                    <div className={`portfolio-content${firstIn ? ' show-content' : ''}`}>
                        <img src={Weather1} alt="project" />
                        <div className="portfolio-content__show center-content">
                            <div className="title">
                            <h5>WEATHER APP</h5>
                                <p>HTML / CSS / Javascript</p>
                            ...
                            <div className="button">
                                <button onClick={() => setVisibleEight(true)}>LEARN MORE</button>
                            </div>
                        </div>
                    </div><br />
                </div>
            ...
            >
                <div className="modal-body">
                    <div className="modal-body__content">
                        <h3>WEB BASED CBT APPLICATION</h3>
                        <p>
            ...
            >
                <div className="modal-body">
                    <div className="modal-body__content">
                        ...
                        <p>
                            The final user is the <soan className="user-type">student user</soan>. They are able to check their result using 
            ...
            >
                <div className="modal-body">
                    <div className="modal-body__content">
                        ...
                        <div className="modal-body__content-buttons">
                            <a href="fees.devugo.com" rel="opener" target="_blank" className="btn"><i className="fa fa-eye"></i> Live Demo</a>
                        </div><br />
                    </div>
                    <div className="modal-body__images">
            ...
            <Modal
                visible={visibleSeven}
                onCancel={() => setVisibleSeven(false)}
                centered={true}
                footer={null}
                width={width > 1024 ? '80%' : width > 767 ? '90%' : width > 360 ? '95%' : '100%'}
            >
                <div className="modal-body">
                    <div className="modal-body__content">
                        ...
                        <p>
                            A quote machine that displays quotes from various aurthors randomly with a share button 
                            to share favorite quotes with followers on twitter.
                        </p>
                        <div className="modal-body__content-stacks">
                            <Tag color="orange">HTML</Tag>
                            <Tag color="orange">CSS</Tag>
                        ...
                        <div className="modal-body__content-buttons">
                            <a className="btn" rel="opener" target="_blank" href="https://www.devugo.com/projects/quote_generator/"><i className="fa fa-eye"></i> View Live</a>
                            <a className="btn" rel="opener" target="_blank" href="http://codepen.io/"><i className="fa fa-code"></i> View Code</a>
                        </div><br />
                    </div>
                    <div className="modal-body__images">
                        <img className={activeSlide === 1 ? 'active-slide' : ''} src={Quote1} alt="quote machine" />
                        <img className={activeSlide === 2 ? 'active-slide' : ''} src={Quote2} alt="quote machine" />
                        <img  className={activeSlide === 3 ? 'active-slide' : ''} src={Quote5} alt="quote machine" />
                        <img  className={activeSlide === 4 ? 'active-slide' : ''} src={Quote4} alt="quote machine" />
                        <img  className={activeSlide === 5 ? 'active-slide' : ''} src={Quote3} alt="quote machine" />
                    </div>
                </div>
            </Modal>

            <Modal
                visible={visibleEight}
                onCancel={() => setVisibleEight(false)}
                centered={true}
                footer={null}
                width={width > 1024 ? '80%' : width > 767 ? '90%' : width > 360 ? '95%' : '100%'}
            >
                <div className="modal-body">
                    <div className="modal-body__content">
                        <h3>WEATHER APP</h3>
                        <p>
                            Weather App that displays the current weather of a visitor using the visitor's 
                            location to get the weather using openweather API.
                        </p>
                        <div className="modal-body__content-stacks">
                            <Tag color="orange">HTML</Tag>
                            <Tag color="orange">CSS</Tag>
                        ...
                        <div className="modal-body__content-buttons">
                            <a className="btn" target="_blank" rel="opener" href="https://www.devugo.com/projects/local_weather/"><i className="fa fa-eye"></i> View Live</a>
                            <a className="btn" rel="noreferrer" target="_blank" href="https://codepen.io/devugo/"><i className="fa fa-code"></i> View Code</a>
                        </div><br />
                    </div>
                    <div className="modal-body__images">
                        <img className={activeSlide === 1 ? 'active-slide' : ''} src={Weather1} alt="weather app" />
                        <img className={activeSlide === 2 ? 'active-slide' : ''} src={Weather1} alt="weather app" />
                        <img  className={activeSlide === 3 ? 'active-slide' : ''} src={Weather1} alt="weather app" />
                        <img  className={activeSlide === 4 ? 'active-slide' : ''} src={Weather1} alt="weather app" />
                        <img  className={activeSlide === 5 ? 'active-slide' : ''} src={Weather1} alt="weather app" />
                    </div>
                </div>
            </Modal>
        </section>
